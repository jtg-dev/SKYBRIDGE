...
class egress_edfi implements i_egress {
    ...
    final public static function init(): bool {
        ...
        $ret = self::$edfi_pointer->init(driver::$currentExport['output']['edfi_apiUrlBase'], self::$edfi_apiClientID, self::$edfi_apiClientSecret, self::$edfi_apiSubscriptionKey);
